...
bool isSphereGen = false, isCubeGen = false, isQuadGen = false;
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "IBL specular", NULL, NULL);
	if (window == NULL)
	{
	...
	unsigned int sphereVAO, sphereVBO, sphereEBO, cubeVAO, cubeVBO, quadVAO, quadVBO;
