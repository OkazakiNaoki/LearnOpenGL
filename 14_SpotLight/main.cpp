...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Spot Light", NULL, NULL);
	if (window == NULL)
	{
	...
	GLSLloader cubeObject("shader/vertex.glsl", "shader/fragmentSoftEdge.glsl"); // There's none-SolfEdge frag shader
	...
	cubeObject.SetUniform3f("light.ambient", glm::vec3(0.2f, 0.2f, 0.2f));
	cubeObject.SetUniform3f("light.diffuse", glm::vec3(0.5f, 0.5f, 0.5f));
	cubeObject.SetUniform3f("light.specular", glm::vec3(1.0f, 1.0f, 1.0f));
	cubeObject.SetUniform1f("light.constant", 1.0f);
	cubeObject.SetUniform1f("light.linear", 0.22f);
	cubeObject.SetUniform1f("light.quadratic", 0.2f);
	glm::mat4 model;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		cubeObject.SetUniform3f("light.position", cameraPos);
		cubeObject.SetUniform3f("light.direction", cameraFront);
		cubeObject.SetUniform1f("light.cutOff", glm::cos(glm::radians(12.5f)));
		cubeObject.SetUniform1f("light.outerCutOff", glm::cos(glm::radians(17.5f)));
