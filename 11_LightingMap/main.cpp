...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Lighting Map", NULL, NULL);
	if (window == NULL)
	{
	...
	//*********************************************
	//	Load diffuse map, specular map and emission map
	//*********************************************
	...
	TexLoader emissMap("texture/matrix.jpg");
	unsigned int emissMapID = emissMap.GetMapID();

	glm::vec3 lightPos(1.2f, 0.0f, 0.0f);
	cubeObject.UseProgram();
	//*********************************************
	//	Use diffuse map as diffuse and ambient, specular map as specular
	//*********************************************
	cubeObject.SetUniform1i("material.diffuse", 0);
	cubeObject.SetUniform1i("material.specular", 1);
	cubeObject.SetUniform1i("material.emission", 2);
	cubeObject.SetUniform1f("material.shininess", 32.0f);
	cubeObject.SetUniform3f("light.position", lightPos);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, emissMapID);
