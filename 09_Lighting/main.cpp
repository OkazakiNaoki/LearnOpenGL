...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Lighting", NULL, NULL);
	if (window == NULL)
	{
	...
	//*********************************************
	//	Create a new VAO for lighting cube
	//*********************************************
	...
	cubeObject.SetUniform3f("lightColor", glm::vec3(1.0f, 1.0f, 1.0f));
	cubeObject.SetUniform3f("objectColor", glm::vec3(1.0f, 0.5f, 0.31f));
	cubeObject.SetUniform1f("ambientStrength", 0.1f);
	cubeObject.SetUniform3f("lightPos", lightPos);
	cubeObject.SetUniform1f("specularStrength", 0.5f);
	glm::mat4 model;
