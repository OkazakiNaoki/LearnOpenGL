...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Advanced Lighting", NULL, NULL);
	if (window == NULL)
	{
	...
	TexLoader planeTex("texture/wood.png", GL_REPEAT, GL_LINEAR, GL_LINEAR);
