...
bool isSphereGen = false, isCubeGen = false;
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "IBL Diffuse Irradiance", NULL, NULL);
	if (window == NULL)
	{
	...
	unsigned int sphereVAO, sphereVBO, sphereEBO, cubeVAO, cubeVBO;
	...
	pbrShader.SetUniform3f("albedo", glm::vec3(0.5f, 0.5f, 0.5f));
