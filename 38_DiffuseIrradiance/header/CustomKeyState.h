...
public:
	...
	void UpdateMouseP(GLFWwindow* window, int key);
	void UpdateMouseR(GLFWwindow* window, int key);
	bool GetMouseDown(GLFWwindow* window, int key);
	bool GetMouseUp(GLFWwindow* window, int key);
