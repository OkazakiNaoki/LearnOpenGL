...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Directional Light", NULL, NULL);
	if (window == NULL)
	{
	...
	cubeObject.SetUniform3f("light.direction", glm::vec3(-1.0f, 0.0f, 0.0f));//-0.2f, -1.0f, -0.3f));
